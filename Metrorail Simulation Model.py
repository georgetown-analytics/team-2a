# -*- coding: utf-8 -*-
"""
Created on Thu Sep 01 21:45:40 2016
...
class Metrosimulation (object):
    ...
    at a time. Random delays are throw into the system, which cause delays that can
...
def train(env, name, tr):
    ...
    compounding delays in a previous train was delayed.
...
def setup(env, num_stations, default, t_inter):
    """Create a station, an initial train and keep creating trains

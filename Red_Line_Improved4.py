...
@author: Micah
"""
#This script looks at what the Red Line might looks like with a 30% reduction in the
#probability of each delay tier as well as a three minute reduction at each tier.
